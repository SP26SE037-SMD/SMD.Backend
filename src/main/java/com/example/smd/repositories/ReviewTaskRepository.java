...
@Repository
public interface ReviewTaskRepository extends JpaRepository<ReviewTask, UUID>, JpaSpecificationExecutor<ReviewTask> {
    ...
    @Override
    @EntityGraph(attributePaths = {"task", "reviewer", "reviewer.role"})
    Page<ReviewTask> findAll(Specification<ReviewTask> spec, Pageable pageable);
