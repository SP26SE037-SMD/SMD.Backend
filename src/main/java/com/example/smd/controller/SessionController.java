...
//    @PreAuthorize("hasAuthority('SYLLABUS_UPDATE')")
    ...
    @PostMapping("/syllabus/{syllabusId}/validate-session-type")
    @Operation(
    ...
    public ResponseObject<SessionValidationResult> validateSessionType(
        ...
        return ResponseObject.<SessionValidationResult>builder()
                .status(1000)
                .data(sessionService.validateSessionType(inputs, syllabusId))
